...
!(function($, window, document, undefined) {
            ...
            if ($(this).data("table") === "dnd") {
                $(this).tableDnD({
                    ...
                    onDropStyle:
                        ...
                        null,
                    onDragClass:
                        ($(this).data("ondragclass") === undefined &&
                            "tDnD_whileDrag") ||
                    ...
                    onDragStart:
                        ...
                        new Function(
                            ...
                            "row",
                            $(this).data("ondragstart")
                        ), // 'return eval("'+$(this).data('ondragstart')+'");') || null,
                    onDragStop:
                    ...
                    autoCleanRelations:
                        $(this).data("autocleanrelations") || true,
                    jsonPretifySeparator:
                        $(this).data("jsonpretifyseparator") || "\t",
                    serializeRegexp:
                        ($(this).data("serializeregexp") &&
                            new RegExp($(this).data("serializeregexp"))) ||
                        /[^\-]*$/,
                    serializeParamName:
                        $(this).data("serializeparamname") || false,
    ...
    jQuery.tableDnD = {
        ...
        tableData: function(table) {
            ...
            rows =
                (config.autoCleanRelations && table.rows) ||
